...
class kakeiboController extends Controller
{
    ...
    public function kakeibo_home() //ホーム画面で今月分のデータを取得する
    {
        ...
        $UserName = \Auth::user()->name;
        $datawatas = [
            'user_name' =>$user_name = \Auth::user()->name,
        ];
        //dd($UserName);
        //dd($user);
        //dd($dt);
        ...
        return view('kakeibo_home',$datawatas, compact('UserName', 'recodes', 'sisyutusum', 'syunyusum', 'seireki', 'hiduke', 'tuki', 'total_sisyutu_name', 'total_syunyu_name', 'syusi_name')); //
    }
...
//////////////////テスト///////////////////////////////////////////
    ...
    public function touroku($user_name)
    {
        //$UserName = \Auth::user()->name;
        $datawatas = [
    ...
    public function edit_screen_kakeibo($id, $naiyou, $sisyutu, $syunyuu, $nitizi,$user_name)
