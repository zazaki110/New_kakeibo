...
<header class="header_main">
  <div class="header_menu"><a class="tukibetu" href="{{url('/tarukame_totalling',)}}">月別データ</a>
    ...
    <a class="nyuryoku" href="{{url('/register_member',['user_name'=>$UserName])}}">入力画面</a><a class="nenbetu" href="{{url('/tarukame_nenbetu',)}}">年別データ</a>
...
<body>
  ...
  <table class="table table-striped table_nenbetu">
    ...
    <tr>
      ...
      <td><a href="{{url('edit_screen_kakeibo',['id'=>$syuturyoku->id,'naiyou'=>$syuturyoku->payment_name,'sisyutu'=>$syuturyoku->spending,'syunyuu'=>$syuturyoku->income,'nitizi'=>$syuturyoku->created_at,'user_name'=>$UserName])}}">編集</a>|<a href="{{url('delete_kakeibo',['id'=>$syuturyoku->id])}}">消去</a></td>
    </tr>
    @endforeach
    @endforeach
    @endforeach
